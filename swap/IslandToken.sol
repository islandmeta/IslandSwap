...
contract IslandToken is DelegateERC20, Ownable {
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "Islandswap Token: _addMinter is the zero address");
        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "Islandswap Token: _delMinter is the zero address");
    ...
    function getMinter(uint256 _index) public view onlyOwner returns (address){
        require(_index <= getMinterLength() - 1, "Islandswap Token: index out of bounds");
    ...
    modifier onlyMinter() {
        require(isMinter(msg.sender), "Islandswap Token: caller is not the minter");
        _;
    }
}
